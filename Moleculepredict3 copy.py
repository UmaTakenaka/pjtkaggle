...
submission_csv = pd.read_csv("C:/Users/takenaka.yuma/KaggleFiles/champs-scalar-coupling/sample_submission.csv", index_col='id')
...
index_df_group1 = get_index(test_csv, "1JHC")
